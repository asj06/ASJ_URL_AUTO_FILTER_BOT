...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/SF_Request')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/SFLINKS')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'SFDiscuss')
MSG_ALRT = environ.get('MSG_ALRT', 'Share and Support Us')

# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', 0))
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/SF_How_To_Download')
